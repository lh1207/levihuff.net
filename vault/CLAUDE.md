...
- No em dashes in vault prose. This is a vault-local readability convention.
...
- **Session stop**: the repo-level hook reminds you to refresh `hot.md` when vault notes remain changed. Vault changes are never committed automatically.
