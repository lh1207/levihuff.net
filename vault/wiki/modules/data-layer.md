...
|---|---|---|
| `site.json` | Every page via `base.njk` | Canonical profile, location, credentials, graduation date, contact, and social metadata |
| `answers.json` | About page quick answers and generated `/llms.txt` | Array of distinct `{question, answer}` objects |
